...
There was a cool paper about horses once [@greenwood2020prevalence]
...
```{r plot horses, fig.width=10, fig.height=3, fig.cap="Figure 1. Horse populations for all provinces in Canada between 1940 - 1970.", out.width="100"}
...
Below we zoom in and look at the province of `r max_horses$Province[1]` or `r params$province`:
